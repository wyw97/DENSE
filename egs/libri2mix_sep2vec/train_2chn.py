...
from models.system import SystemPredictedTeacherForcingAutoRegression2chn
...
def main(conf):
    ...
    model_path = "/data1/wangyiwen/repos/graduateproject/speakerbeam/egs/libri2mix/exp/20240629_mixloss/checkpoints/epoch=198-step=115221.ckpt"
    # model_path = "/data1/wangyiwen/repos/graduateproject/speakerbeam/egs/libri2mix/exp/casual_enroll_only_chunkwise_cgLN/checkpoints/epoch=189-step=110010.ckpt"
    if model_path:
    ...
    system = SystemPredictedTeacherForcingAutoRegression2chn(
        model=model,
        loss_func=loss_func,
        optimizer=optimizer,
