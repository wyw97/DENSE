...
from asteroid.masknn.convolutional import TDConvNetReceptiveLength
...
class TimeDomainSpeakerBeamPredictHelp(BaseEncoderMaskerDecoderInformedOutputHelpPredict):
    ...
    Args:
        ...
        skip_chan (int, optional): Number of channels in the skip connections.
            If 0 or None, TDConvNetReceptiveLength won't have any skip connections and the
...
class TDConvNetInformedSeparateHelp(TDConvNetReceptiveLength):
    """
    Adapted from Asteroid class TDConvNetReceptiveLength 
